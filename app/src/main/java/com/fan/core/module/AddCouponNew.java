...
//
//public class AddCouponNew extends AppCompatActivity {
//
//    @Override
...
package com.fan.core.module;
        ...
        import com.fan.core.model.add_coupon.AddCoupon;
        import com.fan.core.model.my_balance.MyBalance;
//        import com.fan.core.model.my_coupon.MyCoupon;
        ...
        import static com.fan.core.util.AppConstants.ADD_COUPON;
 ...
 */
        public class AddCouponNew extends BaseActivity {
        public static final String TAG = AddCouponNew.class.getSimpleName();

        TextView tv_toolbar_head, tv_toolbar_language, tv_add_coupon_amount;
        ...
        Resources resources;
        EditText et_add_coupon_name_add;
        ...
        tv_add_coupon_amount = (TextView) findViewById(R.id.tv_add_coupon_amount);
        et_add_coupon_name_add = (EditText) findViewById(R.id.et_add_coupon_name_add);
        ...
        bt_add_coupon = (Button) findViewById(R.id.bt_add_coupon);

        tv_toolbar_head.setText(getResources().getString(R.string.add_coupon));
        ...
        iv_toolbar_wallet_icon.setVisibility(View.GONE);
                ...
                iv_toolbar_icon_tutorial.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                                startTutorial(AddCouponNew.this);
                        }
                });
                iv_toolbar_back.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                                onBackPressed();
//                                startActivity(new Intent(AddCouponNew.this, MainFragmentActivity.class));
        ...
        callLanguage(AddCouponNew.this, AddCouponNew.this, AddCouponNew.class, resources, 1);
        }
        });
        ...
        callLanguage(AddCouponNew.this, AddCouponNew.this, AddCouponNew.class, resources, 0);
        }
        });

//        tv_add_balance_amount.setText(responsedata.getMyBalance());

        tv_add_coupon_amount.setText(getResources().getString(R.string.birr) + " " + responsedata.getMyBalance());
        ...
        public void onBackPressed() {
                startActivity(new Intent(AddCouponNew.this, MyBalanceActivity.class));
                ...
                try {
                        ...
                        if (requestCode == ADD_COUPON) {
                                ...
                                if (bean.getResponseMessage().equals("Success")) {
                                        ...
                                        tv_add_coupon_amount.setText(getResources().getString(R.string.birr) + " " + bean.getResponsedata().getCurrentBalance());
...
//                                        tv_my_balance_bonus.setText(getResources().getString(R.string.birr) + " " + bean.getResponsedata().getTotalBonus());
        ...
        showDialog("Adding Coupon", true);
        RequestParams params = new RequestParams();
        String am = et_add_coupon_name_add.getText().toString();
        params.put("user_id", responsedata.getId());
        params.put("name", am);
        postService(NetworkAPI.ADD_COUPON, params, ADD_COUPON);
        } else {
