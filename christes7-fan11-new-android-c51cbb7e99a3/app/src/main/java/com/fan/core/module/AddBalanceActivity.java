...
public class AddBalanceActivity extends BaseActivity {
    public static final String TAG = AddBalanceActivity.class.getSimpleName();
       ...
       iv_toolbar_icon_tutorial.setVisibility(View.VISIBLE);
        ...
        iv_toolbar_icon_tutorial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startTutorial(AddBalanceActivity.this);
            }
        });
        ...
        tv_toolbar_language_amheric.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                callLanguage(AddBalanceActivity.this, AddBalanceActivity.this, AddBalanceActivity.class, resources, 1);
            }
        });
        tv_toolbar_language_english.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                callLanguage(AddBalanceActivity.this, AddBalanceActivity.this, AddBalanceActivity.class, resources, 0);
            }
        });
