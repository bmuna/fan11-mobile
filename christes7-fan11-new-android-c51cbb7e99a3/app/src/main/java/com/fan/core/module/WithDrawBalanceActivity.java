...
import static com.fan.core.util.AppConstants.WITHDRAW;
...
public class WithDrawBalanceActivity extends BaseActivity {
    public static final String TAG = WithDrawBalanceActivity.class.getSimpleName();
    ...
    Button bt_with_balance;
    Responsedata responsedata;
    Resources resources;
    LinearLayout ll_with_otp_;
    EditText et_add_balance_amount_add, et_with_balance_amount_add_otp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.withdraw_balance);
        ...
        et_with_balance_amount_add_otp = (EditText) findViewById(R.id.et_with_balance_amount_add_otp);
        ...
        ll_with_otp_ = (LinearLayout) findViewById(R.id.ll_with_otp_);
        bt_with_balance = (Button) findViewById(R.id.bt_with_balance);

        tv_toolbar_head.setText(getResources().getString(R.string.withdraw_amount));
        ...
        iv_toolbar_icon_tutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startTutorial(WithDrawBalanceActivity.this);
            }
        });
        tv_toolbar_language_amheric.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                callLanguage(WithDrawBalanceActivity.this, WithDrawBalanceActivity.this, WithDrawBalanceActivity.class, resources, 1);
            }
        });
        tv_toolbar_language_english.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                callLanguage(WithDrawBalanceActivity.this, WithDrawBalanceActivity.this, WithDrawBalanceActivity.class, resources, 0);
            }
        });
        ...
        bt_with_balance.setText(getResources().getString(R.string.request_OTP));
        bt_with_balance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ll_with_otp_.getVisibility() == View.VISIBLE) {
                    if (!et_with_balance_amount_add_otp.getText().toString().equals("")) {
                        sendRequest();
                    } else {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        /*startActivity(new Intent(AddBalanceActivity.this, Profile.class));*/
        finish();
    }
        ...
        try {
           ...
           /* if (bean.getResponseMessage().equals("Success")) {
            ...
            if (requestCode == SEND_OTP_FOR_PAYMENT_ON_AMOLE) {
                ...
                if (bean.getResponseMessage().equals("Success")) {
                    ll_with_otp_.setVisibility(View.VISIBLE);
                    bt_with_balance.setText(getResources().getString(R.string.withdraw_amount));
                } else {
                    Toast.makeText(this, bean.getResponseMessage(), Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void sendRequest() {
        if (AppConstants.isOnline(this)) {
            showDialog("Withdraw Balance", true);
            RequestParams params = new RequestParams();
            String am = et_add_balance_amount_add.getText().toString();
            params.put("user_id", responsedata.getId());
            params.put("amount", am);
            params.put("payment_otp", et_with_balance_amount_add_otp.getText().toString());
            postService(NetworkAPI.WITHDRAW, params, WITHDRAW);
        } else {
